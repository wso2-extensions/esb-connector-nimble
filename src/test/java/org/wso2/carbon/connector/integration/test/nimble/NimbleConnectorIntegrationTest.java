...
public class NimbleConnectorIntegrationTest extends ESBIntegrationTest {
    ...
    public void getAccessTokenFromRefreshToken() throws Exception {
        ...
        String modifiedJsonString = String.format(jsonString, nimbleConnectorProperties.getProperty("refreshToken"), nimbleConnectorProperties.getProperty("clientId"), nimbleConnectorProperties.getProperty("clientSecret"), nimbleConnectorProperties.getProperty("grantType"), nimbleConnectorProperties.getProperty("redirectUri"));
    ...
    public void getContactNotesListOptional() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "getContactNotesListOptional.txt";
        String methodName = "getContactNotesList";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, nimbleConnectorProperties.getProperty("refreshToken"), nimbleConnectorProperties.getProperty("clientId"), nimbleConnectorProperties.getProperty("clientSecret"), nimbleConnectorProperties.getProperty("grantType"), nimbleConnectorProperties.getProperty("redirectUri"), nimbleConnectorProperties.getProperty("contactId"), nimbleConnectorProperties.getProperty("apiUrl"));
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        JSONObject jsonResponse;
        try {
            jsonResponse = ConnectorIntegrationUtil.sendRequest(getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void getContactsDetails() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, nimbleConnectorProperties.getProperty("refreshToken"), nimbleConnectorProperties.getProperty("clientId"), nimbleConnectorProperties.getProperty("clientSecret"), nimbleConnectorProperties.getProperty("grantType"), nimbleConnectorProperties.getProperty("redirectUri"), nimbleConnectorProperties.getProperty("apiUrl"));
    ...
    public void createTask() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, nimbleConnectorProperties.getProperty("refreshToken"), nimbleConnectorProperties.getProperty("clientId"), nimbleConnectorProperties.getProperty("clientSecret"), nimbleConnectorProperties.getProperty("grantType"), nimbleConnectorProperties.getProperty("redirectUri"), nimbleConnectorProperties.getProperty("apiUrl"), nimbleConnectorProperties.getProperty("relatedTo"));
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"createGroup"}, groups = {"wso2.esb"}, description = "nimble {createField} integration test with mandatory parameter.")
    public void createField() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, nimbleConnectorProperties.getProperty("refreshToken"), nimbleConnectorProperties.getProperty("clientId"), nimbleConnectorProperties.getProperty("clientSecret"), nimbleConnectorProperties.getProperty("grantType"), nimbleConnectorProperties.getProperty("redirectUri"), nimbleConnectorProperties.getProperty("apiUrl"), nimbleConnectorProperties.getProperty("groupId"), nimbleConnectorProperties.getProperty("name"));
    ...
    public void createGroup() throws Exception {
        ...
        try {
            ...
            String groupId = jsonResponse.getString("id");
            nimbleConnectorProperties.setProperty("groupId", groupId);
        } finally {
            proxyAdmin.deleteProxy(methodName);
        }
    }
     ...
     */
    @Test(enabled = true, priority = 2, dependsOnMethods = {"createField"}, groups = {"wso2.esb"}, description = "nimble {updateGroup} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, priority = 3, dependsOnMethods = {"updateGroup"}, groups = {"wso2.esb"}, description = "nimble {updateField} integration test with mandatory parameter.")
    public void updateField() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, nimbleConnectorProperties.getProperty("refreshToken"), nimbleConnectorProperties.getProperty("clientId"), nimbleConnectorProperties.getProperty("clientSecret"), nimbleConnectorProperties.getProperty("grantType"), nimbleConnectorProperties.getProperty("redirectUri"), nimbleConnectorProperties.getProperty("apiUrl"), nimbleConnectorProperties.getProperty("groupId"), nimbleConnectorProperties.getProperty("fieldId"));
